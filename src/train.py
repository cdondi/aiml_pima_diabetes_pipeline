...
os.environ['MLFLOW_TRACKING_URI']="https://dagshub.com/cdondi/machinelearningpipeline.mlflow"
...
def train(data_path,model_path,random_state,n_estimators,max_depth):
    ...
    mlflow.set_tracking_uri("https://dagshub.com/cdondi/machinelearningpipeline.mlflow")
